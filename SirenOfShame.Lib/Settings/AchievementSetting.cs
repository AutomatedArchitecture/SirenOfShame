...
namespace SirenOfShame.Lib.Settings
{
    ...
    public class AchievementSetting
    {
        public static List<AchievementLookup> AchievementLookups = new List<AchievementLookup>
        {
            ...
            new AchievementLookup { Id = AchievementEnum.ChronGrandMaster, Name = "Chron Grand-Master", Description = "Responseible for 96 hours of cumulative build time" },
            ...
            new AchievementLookup { Id = AchievementEnum.LightningFast, Name = "Like Lightning", Description = "Queue 3 builds back to back" },
            ...
            new AchievementLookup { Id = AchievementEnum.UberProductive, Name = "Uber-Productive", Description = "Queued 10+ builds in 1 day" },
